...
<main role="main">
	<div class="container">
				...
				<h1><strong>Error 500:</strong> Internal Server Error</h1>
				<p>An internal server error occured. This often happens during some malfunction of the server. Please check the status of this service.</p>
				<a href="https://status.jhuesser.ch" class="btn btn-success">View status</a>
