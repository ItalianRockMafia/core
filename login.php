...
if ($tg_user !== false) {
  ...
  $html = <<<HTML
<h1>Please login:</h1>
<script async src="https://telegram.org/js/telegram-widget.js?4" data-telegram-login="irmbot" data-size="large" data-auth-url="https://italianrockmafia.ch/check.php" data-request-access="write"></script>
HTML;
}
